...
public class it_usercenter extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tv1 = (TextView)findViewById(R.id.center_tv1);
        TextView tv2 = (TextView)findViewById(R.id.center_tv2);
        TextView tv3 = (TextView)findViewById(R.id.center_tv3);
        TextView tv4 = (TextView)findViewById(R.id.center_tv4);
        TextView tv5 = (TextView)findViewById(R.id.center_tv5);
        TextView tv6 = (TextView)findViewById(R.id.center_tv6);
