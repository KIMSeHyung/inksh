...
public class it_bw_cre_date extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_BLUR_BEHIND,
                ...
                */
        setContentView(R.layout.lay_it_cre_date);

        it_bw_cre_fr_1.is_check_date = true;
        it_bw_cre_fr_2.is_check_date = true;
